...
if(isset($_POST['submit'])){
    ...
    if(mysqli_num_rows($res2)>0){
        ...
        if($acc_no!=$r_acc_no){
            $receiver_update = mysqli_query($con,"UPDATE user SET balance='$r_newbal' WHERE acc_no='$r_acc_no'");
            $sender_update = mysqli_query($con,"UPDATE user SET balance='$s_newbal' WHERE acc_no='$acc_no'");
            mysqli_query($con,"INSERT INTO transaction (p_name,s_name,acc_no,amount) VALUES ('$s_name','$r_name','$acc_no','$namount')");
            mysqli_query($con,"INSERT INTO transaction (p_name,s_name,acc_no,amount) VALUES ('$r_name','$s_name','$r_acc_no','$amount')");
...
<body>
    ...
    <div class="extra_maal">
        <div class="profile">
            ...
            <br>
            <div class="bal">Balance <mark class="bala">₹<?php echo $balance; ?></mark></div>
        </div>
    </div>
    <script>
        ...
        var wdth=pf.offsetWidth+tr.offsetWidth+th.offsetWidth+ul.offsetWidth+32;
        ...
        function prfl() {
            ...
            exm.innerHTML="<div class='profile'><div class='hi'>Hi,<?php echo ' ',$name; ?></div><div class='acc_no'><mark class='accn'><?php echo $acc_no; ?></mark></div><br><div class='bal'>Balance <mark class='bala'>₹<?php echo $balance; ?></mark</div></div>";
        }
        function trct() {
        ...
        function usli() {
            ...
            sel.style.width=ul.offsetWidth+"px";
